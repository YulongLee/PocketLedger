...
import { dateKey, localDate, periodRange, previousRange, normalizeEntries, totals, within, change, categoryRows, timeline, money } from '../../utils/statistics'
...
Page({
  ...
  async load() {
    ...
    try {
      ...
      const used = sum.expense / 100, percent = Math.min(100, Math.round(used / budgetTotal * 100))
